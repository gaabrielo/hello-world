  ...
  return (
    <div className="w-full flex flex-col items-start min-h-screen p-8 text-[#121212]">
      <div className="w-full gap-4 grid grid-cols-1 sm:grid-cols-2">
        <div className="col-span-1 bg-[#E0E0E0] rounded-[2.5rem] flex flex-col items-start justify-between p-10">
          <p className="font-mondwest uppercase text-4xl! leading-11 lg:text-7xl! lg:leading-15">
            stop wasting money on AI that doesn’t understand your business
          </p>
          <button className="bg-[#FF6800] text-xl! text-white px-5 py-3.5 rounded-full flex items-center gap-3.5 w-full sm:w-fit justify-center mt-10 sm:mt-0">
      ...
      <div className="flex justify-between mt-20 items-end w-full">
        ...
        <p className="font-mondwest uppercase text-5xl! text-right leading-12 max-w-5xl text-zinc-300">
